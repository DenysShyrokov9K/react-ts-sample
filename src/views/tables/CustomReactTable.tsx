...
import ReactTable from 'react-table-v6';//@ts-ignore
...
import {SobjType} from './style'

const TreeTable = treeTableHOC(ReactTable);

const CustomReactTable = () => {
  const [modal, setModal] = useState(false);
  const [obj, setObj] = useState<SobjType>({});
    ...
    return {
      ...
      actions: (
        ...
        <div className="text-center">
          ...
          <Button
            onClick={() => {
              const sobj = data2.find((o : any) => o.id === key);
              setModal(!modal);
              setObj(sobj as SobjType);
            }}
            color="inverse"
            size="sm"
            round="true"
