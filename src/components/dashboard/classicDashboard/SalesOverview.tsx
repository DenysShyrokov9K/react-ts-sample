...
import {OptionsSaleSummaryType , SeriesSalesSummryType ,StatesType} from './interface';

const optionssalesummary : OptionsSaleSummaryType = {
  chart: {
    id: 'basic-bar',
...
const seriessalessummry : SeriesSalesSummryType[] = [
  {
    name: 'Site A view',
        ...
        <Col lg="8">
          <div className="campaign ct-charts">
            <div className="chart-wrapper" style={{ width: '100%', margin: '0 auto', height: 250 }}>
              <Chart
                options={optionssalesummary as any}
