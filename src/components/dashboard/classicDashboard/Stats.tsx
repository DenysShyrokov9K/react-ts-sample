...
import { OptionsRevenueType, SeriesRevenueType ,OptionsPageViewsType ,SeriesPageBiewsType } from './interface';
...
const seriespageviews : SeriesPageBiewsType[] = [
  {
    name: 'Views',
            ...
            <div className="d-flex align-items-center mb-3 pb-2">
              ...
              <div className="ms-auto">
                <div className="chart-wrapper mb-3" style={{ maxWidth: '150px', height: '55px' }}>
                  <Chart options={optionsbounce as any} series={seriesbounce} type="area" />
                </div>
              </div>
            </div>
          </CardBody>
