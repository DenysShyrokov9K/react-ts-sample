...
import { OptionSrevenueType, SeriesRevenueType ,OptionsPageViewsType, SeriesPageViewsType ,SeriesBounceType ,OptionsbounceType} from './interface';

const RevenuePageBounce = () => {
  // revenue chart
  const optionsrevenue : OptionSrevenueType = {
    chart: {
      id: 'basic-bar',
  ...
  const seriesrevenue : SeriesRevenueType[] = [
    {
      name: 'Net Profit',
  ...
  // page views chart
  const optionspageviews : OptionsPageViewsType = {
    chart: {
      id: 'basic-bar',
      type: 'area',
      toolbar: {
  ...
  const seriespageviews : SeriesPageViewsType[] = [
    {
      name: 'Views',
  ...
  // bounce chart
  const optionsbounce : OptionsbounceType = {
    grid: {
      show: false,
      padding: {
        left: 0,
  ...
  const seriesbounce : SeriesBounceType[] = [
    {
      name: 'Rate',
      ...
      <Row>
        ...
        <Col sm="12" lg="4">
          <Card className="bg-info">
            ...
            <div>
              <Chart options={optionspageviews as any} series={seriespageviews} type="line" height="90" />
            </div>
          </Card>
        </Col>
        <Col sm="12" lg="4">
              ...
              <div className="d-flex align-items-center mb-3 pb-1">
                ...
                <div className="ms-auto">
                  <div className="mb-3" style={{ maxWidth: '150px', height: '55px' }}>
                    <Chart options={optionsbounce as any} series={seriesbounce} type="area" height="110" />
                  </div>
                </div>
              </div>
            </CardBody>
